...
global_path = [(-4.9, 4),(4.9, 0),(4.9, 3.0),(-4.9, 3.0),(-4.9, 1.0),(4.9, 1.0), (4.9, 0.0), (-4.9, 0.0), (-4.9, -2.0), ( 4.9, -2.0), (4.9, -3.0), (-4.9, -3.0)]
...
def set_robot_state(x,y,yaw):
    ...
    req.model_state.model_name = "mbot"
...
def image_callback(rgb_img, depth_img):
    global flag, cmd, upper_lettuce, upper_weed, lower_weed, upper_cabbage, lower_cabbage
    ...
    #detect cabbage
    hsv = cv2.cvtColor(rgb, cv2.COLOR_BGR2HSV) #Transform BGR value to HSV;
    mask_after_segment = cv2.inRange(hsv, lower_weed, upper_weed)
    cv2.imshow("mask_after_segment", mask_after_segment)
...
def main():
    global cmd, set_model_state_client
